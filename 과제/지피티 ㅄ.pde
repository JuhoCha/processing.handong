...
void draw() {
  ...
  sheep1X += sheep1Xd * sheep1Xs; // motion of Sheep1 in x direction
  sheep1Y += sheep1Yd * sheep1Ys; // motion of Sheep1 in y direction
  if (sheep1X < 0 + 7 * sheepUnit || sheep1X > width - 7 * sheepUnit) sheep1Xd = -sheep1Xd; // Sheep1: direction change at left and right edges
  ...
  sheep2X += sheep2Xd * sheep2Xs; // motion of Sheep2 in x direction
  sheep2Y += sheep2Yd * sheep2Ys; // motion of Sheep2 in y direction
  if (sheep2X < 0 + 7 * sheepUnit || sheep2X > width - 7 * sheepUnit) sheep2Xd = -sheep2Xd; // Sheep2: direction change at left and right edges
  if (sheep2Y < 0 + 7 * sheepUnit || sheep2Y > height - 7 * sheepUnit) sheep2Yd = -sheep2Yd; // Sheep2: direction change at top and bottom edges
  sheep(sheep2X, sheepY2, sheep2Xd); // draw Sheep2
  ...
  if (d < 7 * sheepUnit + 7 * sheepUnit) { // if it is shorter than the sum of radius of two bodies
    sheep1Xd = 0; // stop Sheep1
    sheep2Xd = 0; // stop Sheep2
  }
